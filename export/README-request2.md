# Results export, request 2 of 2 — "Arming the Body Politic – Semantics of Arms"
...
- request 1:            bigrams.csv + volumes.csv + README        (57.0 MB)
- request 2 (this one): trigrams.csv + this README                (53.9 MB)
...
|---|---|---|---|
| trigrams.csv | w1, w2, w3, htid, year, count | anchor term with both adjacent tokens x volume | 1,208,332 |
...
Total size of this request: 53.9 MB. Plain-text CSV and Markdown only; no binary,
